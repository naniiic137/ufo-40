...
enum {
    P_POSY_DOWN1, P_POSY_DOWN2, P_POSY_UP1, P_POSY_UP2, P_POSY_SIDE1, P_POSY_SIDE2, P_POSY_HOP, P_POSY_FALL,
    P_PUP1, P_PUP2, P_PUP_TRAIL, P_BRAMBLE1, P_BRAMBLE2, P_BRAMBLE_DAZED,
    P_TOAD1, P_TOAD2, P_JAR, P_WITCH, P_WITCH_CACKLE, P_POSY_BIG, P_HEART, P_PETAL,
    P_SPRITE_COUNT
};
